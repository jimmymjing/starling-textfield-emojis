    ...
    public class TextField extends DisplayObjectContainer
    {
        ...
        private function recompose():void
        {
            if (_requiresRecomposition)
            {
                ...
                // this is addition 1.
                if(_compositor is EventDispatcher ) EventDispatcher( _compositor ).addEventListener('textRendered', onCompositorTextRendered );
                updateText();
                updateBorder();
        ...
        // this is addition 2.
        private function onCompositorTextRendered(event:Event):void {
            event.currentTarget.removeEventListener('textRendered', onCompositorTextRendered );
            dispatchEvent(event);
        }
