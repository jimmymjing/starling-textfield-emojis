...
import starling.text.*;
     ...
     */
    public class MyCustomTrueTypeCompositor extends EventDispatcher implements ITextCompositor
    {

        public static const TEXT_RENDERED:String = "textRendered";
        ...
        public function MyCustomTrueTypeCompositor()
        {}
                                    ...
                                    format:TextFormat, options:TextOptions):BitmapDataEx
        {
            ...
            else
            {
                ...
                // this is the only change made to TrueTypeCompositor... dispatch event BEFORE drawing bitmapData.
                // so we can adjust the text if needed.
                dispatchEventWith( TEXT_RENDERED, true, { nativeTextField: sNativeTextField, scale:options.textureScale });
